...
If no compilation errors popped up, you can start uploading (i.e 'flashing') the firmware to your Ai-Thinker LED RGBW light using an USB/UART FTDI (or equivalent) adapter. This is, of course, a required step since your Ai-Thinker LED RGBW light still has the original factory firmware.
...
If the upload of the **AiLight** firmware was successful, it is recommended restarting your Ai-Thinker LED RGBW light. This can be done by reconnecting the power of your USB/UART FTDI (or equivalent) adapter.
...
Your Ai-Thinker LED RGBW light is now ready and runs the **AiLight** firmware! Please go ahead and disconnect the USB/UART FTDI (or equivalent) adapter or AiLight Jig and put your Ai-Thinker LED RGBW light in your kitchen light, ceiling light, etc.
